...
namespace ProEventos.Application.DTOs
{
    ...
    public class EventoDto
    {
        ...
        // MaxLength(50, ErrorMessage = "O campo {0} deve ter no máximo 50
        // caracteres.")
        StringLength(50, MinimumLength = 3,
                        ErrorMessage = "O campo {0} permitide de 3 a 50 caracteres.")
        ]
        public string Tema { get; set; }

        [Display(Name = "Qtd de Pessoas")]
        [Required(ErrorMessage = "O campo {0} é obrigatório.")]
        [Range(1, 120000, ErrorMessage = "O campo {0} permitide um valor de 1 até 120000.")]
